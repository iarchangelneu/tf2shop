                ...
                <div>
                    ...
                    <div class="showpass">
                        <input :type="showPassword ? 'text' : 'password'" name="password-repeat" id="password-repeat"
                            placeholder="Повторите пароль" v-model="repeat_password">
                        <img @click="togglePasswordVisibility('password-repeat')" src="@/assets/img/showpass.svg" alt=""
                            srcset="" />
                    </div>
                </div>
...
<script setup>
useSeoMeta({
    title: 'Регистрация | TF2Shop',
    ogTitle: 'Регистрация | TF2Shop',
    description: 'Регистрация | TF2Shop',
    ogDescription: 'Регистрация | TF2Shop',
})
</script>
